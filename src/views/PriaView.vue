...
<template>
  <main>
    <img id="logo" src="../assets/bannerPA.jpg" alt="">

    <div class="menu-home" style="display: flex;justify-content: center;">
      <img src="../assets/product/1.png" style="border-radius: 10px;" alt="">
      <img src="../assets/product/2.png" style="border-radius: 10px;" alt="">
    </div>
    <div style="width: 100%;">
