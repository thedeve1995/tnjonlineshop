...
<template>
  <main>
    <img src="../assets/bannerPA.jpg" alt="" style="width: calc(100% - 20px);margin:0 10px;border-radius: 10px;">

    <div class="menu-home" style="display: flex;justify-content: center;">
      <img src="../assets/product/1.png" style="border-radius: 10px;" width="400" alt="">
      <img src="../assets/product/2.png" style="border-radius: 10px;" width="400" alt="">\
    </div>
    <div style="width: 100%;">
